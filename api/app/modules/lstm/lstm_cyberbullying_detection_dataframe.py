...
model_file = os.path.join(os.path.join(os.path.join(os.getcwd(),'app'),'model'),'cyber_2_state_dict.pt')
...
class detect_cyberbullying_ltsm_dataframe:
    ...
    def predict(self):
        ...
        with torch.no_grad():
            h = self.model.init_hidden(self.input_shape)
